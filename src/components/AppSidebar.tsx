    ...
    <Sidebar className="bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-800 text-white border-r-0 shadow-2xl">
      <SidebarHeader className="p-6 border-b border-white/20 bg-black/20 backdrop-blur-sm">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="font-bold text-xl bg-gradient-to-r from-orange-300 to-yellow-300 bg-clip-text text-transparent">
              CHELLO
            </h2>
            <p className="text-sm text-purple-200 font-medium">RESTAURANT POS</p>
          </div>
        </div>
      </SidebarHeader>
      ...
      <SidebarContent className="p-4 space-y-2">
        ...
        <SidebarGroup>
          <SidebarGroupLabel className="text-orange-300 text-sm font-bold px-3 py-3 bg-orange-500/20 rounded-lg border border-orange-400/30">
            🚀 Portals
          </SidebarGroupLabel>
          <SidebarGroupContent>
            <SidebarMenu>
